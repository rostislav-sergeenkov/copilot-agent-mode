        ...
        <Routes>
          ...
          <Route path="/" element={
            <div className="text-center mt-5">
              ...
              <p className="lead">Track your fitness, activities, teams, and more.</p>
              <div className="card mx-auto mt-4" style={{maxWidth: '30rem'}}>
                <div className="card-body">
                  <h5 className="card-title">Get Started</h5>
                  <p className="card-text">Use the navigation menu to explore activities, teams, users, workouts, and the leaderboard.</p>
