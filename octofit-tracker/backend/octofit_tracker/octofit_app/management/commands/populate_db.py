...
from octofit_tracker.octofit_app.models import User, Team, Activity, Workout, Leaderboard
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        w2 = Workout.objects.create(name='Power Circuit', description='Strength and endurance circuit.')
